...
LegendaryZapdosDeck:
	...
	card_item FLYING_PIKACHU,           4
	card_item SURFING_PIKACHU_LV13,    3
	card_item PIKACHU_LV14,   4
	card_item ZAPDOS_LV64,       4
	card_item ZAPDOS_LV68,       4
	card_item JIGGLYPUFF_LV13,             4
	card_item PROFESSOR_OAK,            2
	card_item BILL,            2
...
LegendaryArticunoDeck:
	...
	card_item EXEGGUTOR,           4
	card_item SEEL,            4
	card_item DEWGONG,     2
	card_item ARTICUNO_LV35,     4
	card_item DITTO,             4
	card_item PROFESSOR_OAK,            2
	card_item BILL,            4
	card_item POKEMON_TRADER,           2
...
RockCrusherDeck:
	...
	card_item DOUBLE_COLORLESS_ENERGY,  2
	card_item ROCKRUFF,                 4
	card_item LYCANROC,                  2
	card_item LYCANROCM,                  2
	card_item CUBONE,                  4
	card_item MAROWAK_LV26,                 3
	card_item MAROWAK_LV32,                    3
...
FireChargeDeck:
	...
	card_item FLAREON_LV22,              4
	card_item ARCANINE_LV34,              4
	card_item LICKITUNG,              4
